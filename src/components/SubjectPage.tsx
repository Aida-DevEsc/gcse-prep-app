...
import SpanishListening from './SpanishListening';
import SpanishWriting from './SpanishWriting';
...
export default function SubjectPage() {
  ...
  const hasSkills = subjectId === 'spanish';
  const requestedTab = searchParams.get('tab');
  const tab = requestedTab === 'papers' || (hasSkills && (requestedTab === 'listening' || requestedTab === 'writing')) ? requestedTab : 'topics';
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <div className="flex gap-1 border-b border-slate-200 mb-6 overflow-x-auto">
        {[
          ...
          ...(hasSkills ? [{ key: 'listening', label: '🎧 Listening' }, { key: 'writing', label: '✍️ Writing' }] : []),
      ...
      {tab === 'listening' && <SpanishListening />}
      {tab === 'writing' && <SpanishWriting />}
