      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
            ...
            <p className="text-sm text-slate-500 mb-3">{diagnosticsDone}/{subjects.length} subjects tested</p>
            {diagnosticsDone < subjects.length && (
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                {diagnostic ? (() => {
                  const c = countStatuses(getSubjectStatuses(subject, state));
                  return (
                    <span className="text-xs text-slate-500">
                      <span className="text-red-600">🔴 {c.priority}</span> · <span className="text-amber-600">🟠 {c.gap}</span>
                      {c.untested > 0 && <span className="text-slate-400"> · {c.untested} untested</span>}
                    </span>
                  );
                })() : (
