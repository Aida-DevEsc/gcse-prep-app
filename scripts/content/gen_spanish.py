...
""",
    ...
    [('Me llevo bien con mi hermana', 'I get on well with my sister'),
     ...
     ('although', 'aunque')],
    [
        q('sp-id-q1', 'What does "Me llevo bien con mi hermana" mean?', ["I get on well with my sister","I argue with my sister","I live with my sister","I look a lot like my older sister"], "I get on well with my sister", 'Llevarse bien con = to get on well with.', 'foundation'),
        ...
        q('sp-id-q6', 'What does "Cuando era pequeña, me peleaba mucho con mi primo" tell you?', ["She is going to argue with her cousin when she is older","She never argued with her cousin when she was little","She argues a lot with her cousin now that they are older","When she was little, she often argued with her cousin"], "When she was little, she often argued with her cousin", 'Era and peleaba are imperfect — repeated past actions.', 'higher'),
        ...
        q('sp-id-q9', 'Choose the correct form: "Si tuviera un hermano, ___ muy feliz." (grade 8–9 structure)', ["serías","sería","soy","seré"], "sería", 'Si + imperfect subjunctive (tuviera) is followed by the conditional (sería): "If I had a brother, I would be very happy."', 'further'),
        q('sp-id-q10', 'In "Nos llevamos genial, aunque a veces discutimos", what does "aunque" add?', ["It means \"although\" and adds a contrasting idea","It means \"never\" and makes the sentence negative","It means \"because\" and gives a reason for the idea","It means \"always\" and shows how often they argue"], "It means \"although\" and adds a contrasting idea", 'Complex sentences with contrast are a hallmark of higher-grade answers.', 'further'),
    ])
...
""",
    ...
    [
        q('sp-hl-q1', 'What does "Como mucha fruta y verdura" mean?', ["I buy a lot of fruit and vegetables","I cook a lot of fruit and vegetables","I eat a lot of fruit and vegetables","I like fruit but I don't like vegetables"], "I eat a lot of fruit and vegetables", 'Como = I eat (comer).', 'foundation'),
        q('sp-hl-q2', 'How do you say "to be fit"?', ["estar en forma","ser en forma","hacer en forma","tener la forma"], "estar en forma", 'Estar en forma is the set phrase.', 'foundation'),
        ...
        q('sp-hl-q6', 'What has changed? "Antes comía mucha comida basura, pero ahora intento comer sano."', ["She has always eaten healthily and still does now","She has started eating junk food instead of healthy food","She is going to start eating junk food again soon","She used to eat junk food but now tries to eat healthily"], "She used to eat junk food but now tries to eat healthily", 'Antes + imperfect (comía) vs ahora + present (intento).', 'higher'),
        ...
        q('sp-hl-q10', 'In "Es esencial que los jóvenes hagan ejercicio", why "hagan" and not "hacen"?', ["\"Es esencial que\" is followed by the subjunctive","\"Hagan\" is the future tense of the verb hacer","\"Hacen\" is never correct in any Spanish sentence","\"Hagan\" is the preterite, as the action is finished"], "\"Es esencial que\" is followed by the subjunctive", 'Impersonal expressions of necessity + que + a new subject trigger the subjunctive.', 'further'),
    ])
...
""",
    ...
    [
        ...
        q('sp-ed-q2', 'What does "Está prohibido usar el móvil en clase" mean?', ["Using your mobile in class is forbidden","I don't allow mobiles in my classroom","Mobiles are allowed in class at break time","You must use your mobile phone in class"], "Using your mobile in class is forbidden", 'Está prohibido + infinitive = it is forbidden to…', 'foundation'),
        q('sp-ed-q3', 'Which means "I have to do my homework"?', ["Hay que los deberes hacer","Tengo hacer los deberes","Tengo que hacer los deberes","Debo de los deberes hacer"], "Tengo que hacer los deberes", 'Tener que + infinitive = to have to.', 'intermediate'),
        ...
        q('sp-ed-q5', 'What does "Me gustaría trabajar como médico porque quiero ayudar a la gente" mean?', ["I will work as a doctor with people who want to help others","I worked as a doctor for a while so that I could help people","I like working as a doctor because I help lots of people every day","I would like to work as a doctor because I want to help people"], "I would like to work as a doctor because I want to help people", 'Me gustaría (conditional) = I would like.', 'higher'),
        ...
        q('sp-ed-q8', 'What does "Llevo tres años estudiando español" mean?', ["I carry three Spanish books to school every day","I have been studying Spanish for three years","I studied Spanish for three years at a school","I will study Spanish for the next three years"], "I have been studying Spanish for three years", 'Llevar + time + gerund expresses how long something has been going on.', 'further'),
        q('sp-ed-q9', 'In "Cuando termine el instituto, quiero hacer un aprendizaje", why "termine"?', ["\"Termine\" is the imperfect, as it describes a habit","\"Cuando\" + future meaning takes the subjunctive","\"Termine\" is the preterite, as the action is finished","It is a mistake — the verb should be \"termino\""], "\"Cuando\" + future meaning takes the subjunctive", 'Cuando + future meaning → subjunctive: a grade 8–9 structure.', 'further'),
        q('sp-ed-q10', 'Which sentence would score highest in a Writing task about school?', ["Aunque los profesores son estrictos, me encanta mi instituto porque hay muchas actividades.","El instituto tiene profesores, alumnos, aulas, un gimnasio, una biblioteca y un comedor grande.","Mi instituto es grande y tiene muchos profesores y muchos alumnos y muchas clases y muchas aulas.","Me gusta el instituto y me gustan los profesores y me gustan las asignaturas y me gusta el patio."], "Aunque los profesores son estrictos, me encanta mi instituto porque hay muchas actividades.", 'It combines contrast (aunque), a strong opinion and a justification (porque).', 'further'),
    ])
...
""",
    ...
    [
        ...
        q('sp-ft-q4', 'What does "Suelo ver series en Netflix" mean?', ["I am going to watch a series on Netflix","I usually watch series on Netflix","I only ever watch series on Netflix","I never watch any series on Netflix"], "I usually watch series on Netflix", 'Soler + infinitive = to usually do something.', 'intermediate'),
        q('sp-ft-q5', 'What did they do? "El fin de semana pasado fui al cine con mis amigos y vimos una película de terror."', ["Last weekend they went to the cinema and saw a horror film","They go to the cinema with their friends every single weekend","Next weekend they are going to the cinema to see a horror film","Last weekend they went to the cinema and watched a comedy"], "Last weekend they went to the cinema and saw a horror film", 'Fui and vimos are preterite; película de terror = horror film.', 'higher'),
        ...
        q('sp-ft-q8', 'What does "Hace dos años que toco el piano" mean?', ["I played the piano two years ago, but I stopped","I have been playing the piano for two years","I will play the piano again in two years' time","I played the piano for two years when I was young"], "I have been playing the piano for two years", 'Hace + time + que + present = something that started in the past and is still going on.', 'further'),
        q('sp-ft-q9', 'What does "Si tuviera más tiempo libre, aprendería a bailar salsa" mean?', ["If I had more free time, I would learn to dance salsa","I had more free time, so I learnt how to dance salsa","If I have more free time, I will learn to dance salsa","I would have learnt salsa if I had had more free time"], "If I had more free time, I would learn to dance salsa", 'Si + imperfect subjunctive (tuviera) + conditional (aprendería).', 'further'),
        q('sp-ft-q10', 'Which sentence shows three different time frames?', ["Me gusta mucho el tenis, me encanta la natación y me interesa bastante el surf también.","Juego al tenis los lunes, nado los martes, corro los miércoles y hago surf los jueves.","Antes jugaba al tenis, ahora prefiero nadar y el año que viene voy a probar el surf.","Jugaba al tenis, nadaba en el mar, corría por el parque y hacía surf con mis primos."], "Antes jugaba al tenis, ahora prefiero nadar y el año que viene voy a probar el surf.", 'Imperfect (jugaba), present (prefiero) and near future (voy a probar).', 'further'),
    ])
...
""",
    ...
    [
        q('sp-fe-q1', 'What happens at La Tomatina?', ["People run through the streets with bulls","Giant papier-mâché figures are burned","People throw tomatoes at each other","People eat twelve grapes at midnight"], "People throw tomatoes at each other", 'La Tomatina in Buñol is a huge tomato fight.', 'foundation'),
        ...
        q('sp-fe-q4', 'What is the tradition at midnight on Nochevieja in Spain?', ["Running through the streets with bulls","Throwing tomatoes at friends and family","Burning giant figures in the main square","Eating twelve grapes, one on each chime"], "Eating twelve grapes, one on each chime", 'Las doce uvas bring good luck for each month of the new year.', 'intermediate'),
        q('sp-fe-q5', 'What does "El Día de los Muertos se celebra en México para recordar a los familiares que han muerto" mean?', ["Mexicans celebrate the day to forget relatives who have died","In Mexico, the Day of the Dead remembers relatives who have died","The Day of the Dead is Spain's version of the Halloween festival","The festival in Mexico is a celebration of living people only"], "In Mexico, the Day of the Dead remembers relatives who have died", 'Recordar = to remember; han muerto = have died (perfect tense).', 'higher'),
        ...
        q('sp-fe-q8', 'In "Se come mucho turrón en Navidad", what does "se come" mean?', ["You should eat turrón at Christmas","A lot of turrón is eaten at Christmas","He eats a lot of turrón at Christmas","We ate lots of turrón last Christmas"], "A lot of turrón is eaten at Christmas", 'Impersonal se describes what people generally do.', 'further'),
        q('sp-fe-q9', 'What does "Durante la Semana Santa hay procesiones por las calles" mean?', ["Holy Week is a summer festival with street parties","There are processions through the streets every week","At Christmas there are parades through the city streets","During Holy Week there are processions in the streets"], "During Holy Week there are processions in the streets", 'Semana Santa = Holy Week, the week before Easter.', 'further'),
        q('sp-fe-q10', 'Which sentence would gain the most credit when describing a festival?', ["Me gustan las fiestas españolas y me gustan las Fallas y me gusta la Tomatina.","Hay muchas fiestas en España, como las Fallas, la Tomatina y los Sanfermines.","Las Fallas son en Valencia y hay muchas figuras grandes y mucha gente y petardos.","Fui a las Fallas el año pasado; fue impresionante, aunque había demasiada gente."], "Fui a las Fallas el año pasado; fue impresionante, aunque había demasiada gente.", 'Preterite, imperfect, an evaluation and a contrast in one sentence.', 'further'),
    ])
...
""",
    ...
    [
        ...
        q('sp-ce-q5', 'What is the speaker\'s view? "Los famosos ganan demasiado dinero y no tienen vida privada."', ["Neutral — the speaker doesn't give any opinion","Positive — celebrities deserve every penny they earn","Negative — they earn too much and lose their privacy","The speaker would like to become famous one day"], "Negative — they earn too much and lose their privacy", 'Demasiado = too much; no tienen vida privada = they have no private life.', 'higher'),
        ...
        q('sp-ce-q8', 'In "No creo que la fama sea importante", why "sea" and not "es"?', ["\"Sea\" follows every verb of thinking in Spanish","\"Sea\" is the preterite form of the verb ser, as the belief is over","It is a spelling mistake for the word \"es\"","\"No creo que\" shows doubt, so it takes the subjunctive"], "\"No creo que\" shows doubt, so it takes the subjunctive", 'Creo que + indicative, but no creo que + subjunctive.', 'further'),
        q('sp-ce-q9', 'What does "Si fuera famoso, usaría mi fama para ayudar a los demás" mean?', ["I would like to be famous so that I could help myself","If I am famous, I will use my fame to help my family","I was famous once and I used my fame to help others","If I were famous, I would use my fame to help others"], "If I were famous, I would use my fame to help others", 'Si + imperfect subjunctive (fuera) + conditional (usaría).', 'further'),
        q('sp-ce-q10', 'Which is the most developed opinion?', ["Aunque algunos famosos son buenos modelos, creo que muchos jóvenes se sienten presionados.","No me gustan los famosos porque son ricos y no me gustan sus fotos en Instagram.","Los famosos son guays y ricos y tienen coches y casas enormes y ropa muy bonita y muchos amigos.","Me gustan los famosos y me gustan sus canciones y me gustan sus películas también."], "Aunque algunos famosos son buenos modelos, creo que muchos jóvenes se sienten presionados.", 'It balances two views, gives a reason and uses a relative clause.', 'further'),
    ])
...
""",
    ...
    [
        ...
        q('sp-tr-q8', 'What does "Lo mejor del viaje fue conocer a gente de otros países" mean?', ["The trip was even better than getting to know people from other countries","I met the best people in the world while I was travelling abroad","The best thing about the trip was meeting people from other countries","Getting to know other countries was better than the trip itself"], "The best thing about the trip was meeting people from other countries", 'Lo mejor = the best thing; conocer a gente = to meet people.', 'further'),
        q('sp-tr-q9', 'What does "Si hubiera tenido más dinero, me habría quedado más tiempo" mean? (grade 9 structure)', ["If I had more money, I would stay there longer","I had more money, so I stayed there a lot longer","If I have more money, I will stay a little longer","If I had had more money, I would have stayed longer"], "If I had had more money, I would have stayed longer", 'Pluperfect subjunctive + conditional perfect: a regret about the past.', 'further'),
        q('sp-tr-q10', 'In "Fui a Madrid y hacía mucho calor", why "fui" but "hacía"?', ["Both verbs are in exactly the same tense, so they must match each other","\"Hacía\" is a mistake and should really be \"hizo\" here","\"Fui\" is a completed action; \"hacía\" describes the weather then","\"Fui\" is in the future tense and \"hacía\" is in the present"], "\"Fui\" is a completed action; \"hacía\" describes the weather then", 'This distinction is one of the most tested points in GCSE Spanish.', 'further'),
    ])
...
""",
    ...
    [
        q('sp-me-q1', 'What does "Uso mi móvil para chatear con mis amigos" mean?', ["I chat with my friends about new mobiles","My friends use my mobile to send messages","I use my friends' mobiles to go online","I use my mobile to chat with my friends"], "I use my mobile to chat with my friends", 'Para + infinitive = in order to.', 'foundation'),
        q('sp-me-q2', 'What does "las redes sociales" mean?', ["the social club","the internet café","social media","the network cables"], "social media", 'Red = network.', 'foundation'),
        ...
        q('sp-me-q5', 'What does "Por un lado, internet es muy útil; por otro lado, puede ser peligroso" mean?', ["The internet is dangerous whichever way you choose to look at it","The internet is very useful for everyone and can never be dangerous for anyone","On one hand the internet is useful; on the other, it can be dangerous","One side of the internet is useful, but the other side is not"], "On one hand the internet is useful; on the other, it can be dangerous", 'Por un lado… por otro lado… structures a balanced argument.', 'higher'),
        ...
        q('sp-me-q8', 'In "Es importante que los jóvenes protejan su privacidad en línea", why "protejan"?', ["\"Protejan\" is the future tense of the verb proteger, as it hasn't happened","\"Protejan\" is the imperfect, describing a past habit","\"Es importante que\" + a new subject takes the subjunctive","\"Protejan\" is a noun meaning \"protections\""], "\"Es importante que\" + a new subject takes the subjunctive", 'Proteger → protejan in the subjunctive (g changes to j to keep the sound).', 'further'),
        q('sp-me-q9', 'What does "Si no tuviera móvil, me sentiría aislado" mean?', ["I didn't have a mobile, so I felt very isolated","If I don't have my mobile, I feel really isolated","If I didn't have a mobile, I would feel isolated","I will feel isolated without my mobile next year"], "If I didn't have a mobile, I would feel isolated", 'Si + imperfect subjunctive + conditional: a hypothetical situation.', 'further'),
        q('sp-me-q10', 'Which is the best framework for a balanced opinion in the Writing exam?', ["Es bueno. Es malo. Es bueno. Es muy malo. Es bueno y es malo.","Por un lado… por otro lado… sin embargo… en conclusión, creo que…","Móvil, internet, redes sociales, ordenador, tableta, aplicaciones.","Me gusta el móvil. No me gusta el móvil. Me gusta. No me gusta nada."], "Por un lado… por otro lado… sin embargo… en conclusión, creo que…", 'Connectives organise the argument and show range.', 'further'),
    ])
...
""",
    ...
    [
        q('sp-en-q1', 'What does "Vivo en un pueblo en el campo" mean?', ["I live in a village in the countryside","I live in a town by the sea","I live in a city in the mountains","I live in a flat in the city centre"], "I live in a village in the countryside", 'Pueblo = village/small town; el campo = the countryside.', 'foundation'),
        ...
        q('sp-en-q4', 'What does "En mi ciudad hay mucho tráfico y contaminación" mean?', ["My town is clean and quiet, with little traffic","There is only a little pollution in my town now","My town has almost no traffic and very little noise","In my town there is a lot of traffic and pollution"], "In my town there is a lot of traffic and pollution", 'Contaminación = pollution.', 'intermediate'),
        q('sp-en-q5', 'Translate: "We should use public transport more."', ["Usaremos menos el transporte público","Deberíamos usar más el transporte público","Usábamos mucho más el transporte público","Debemos usamos más el transporte público"], "Deberíamos usar más el transporte público", 'Deberíamos (conditional of deber) + infinitive = we should.', 'higher'),
        q('sp-en-q6', 'What does "Antes vivía en una ciudad, pero ahora vivo en la costa" mean?', ["I have always lived on the coast, never in a city","I used to live in a city, but now I live on the coast","I am going to move from the city to the coast soon","I live in a city during the week and on the coast at weekends"], "I used to live in a city, but now I live on the coast", 'Vivía (imperfect) contrasts with vivo (present).', 'higher'),
        ...
        q('sp-en-q8', 'What does "Si todos recicláramos, habría menos basura" mean?', ["There will be less rubbish if you recycle at home","If everyone recycled, there would be less rubbish","If everyone recycles, there is always less rubbish","Everyone recycled, so there was much less rubbish"], "If everyone recycled, there would be less rubbish", 'Si + imperfect subjunctive (recicláramos) + conditional (habría).', 'further'),
        q('sp-en-q9', 'In "Es una pena que la gente no cuide el planeta", why "cuide"?', ["\"Es una pena que\" shows emotion, so it takes the subjunctive","\"Cuide\" is a noun meaning \"care\" or \"attention\"","\"Cuide\" is only ever used as a command (imperative)","\"Cuide\" is the preterite form of the verb cuidar, for a finished action"], "\"Es una pena que\" shows emotion, so it takes the subjunctive", 'Expressions of emotion + que + a new subject take the subjunctive.', 'further'),
        q('sp-en-q10', 'Which sentence shows the widest range of structures?', ["Lo que más me preocupa es la contaminación; por eso, voy en bici y me gustaría instalar paneles solares.","La contaminación es mala, el tráfico es malo, la basura es mala, el ruido es malo y el calor es malo también.","Reciclo el papel, reciclo el vidrio, reciclo el plástico, reciclo las latas y reciclo la ropa vieja en casa.","Me preocupa la contaminación. Me preocupa el tráfico. Me preocupa la basura. Me preocupa el ruido. Me preocupa todo."], "Lo que más me preocupa es la contaminación; por eso, voy en bici y me gustaría instalar paneles solares.", 'Lo que…, desde hace + present, and a conditional — three different structures.', 'further'),
    ])
...
""",
    ...
    [
        ...
        q('sp-te-q4', 'Complete: "Me ___ ir a Perú." (I would like)', ["gustaría","gusta","gustaban","gustó"], "gustaría", 'Gustaría is the conditional.', 'intermediate'),
        ...
        q('sp-te-q11', 'Which sentence uses three different tenses correctly?', ["Ayer juego al baloncesto, mañana jugué al tenis y normalmente nadaré.","Normalmente juego al baloncesto, pero ayer nado y mañana juego al tenis.","Normalmente jugué al baloncesto, pero ayer nado y mañana voy a corrí.","Normalmente juego al baloncesto, pero ayer nadé y mañana voy a correr."], "Normalmente juego al baloncesto, pero ayer nadé y mañana voy a correr.", 'Present (juego), preterite (nadé) and near future (voy a correr), each matching its time marker.', 'further'),
    ])
...
""",
    ...
    [
        ...
        q('sp-gr-q5', 'Complete: "Voy a Madrid ___ ver a mis abuelos." (in order to)', ["por","hacia","de","para"], "para", 'Para + infinitive expresses purpose.', 'higher'),
        ...
        q('sp-gr-q8', '"¿El regalo? Se lo di a mi madre." What do "se" and "lo" refer to?', ["\"se lo\" together means \"myself\" in this sentence","\"se\" = himself; \"lo\" = my mother, who got the present","\"se\" = to her (my mother); \"lo\" = it (the present)","It means \"I gave it to myself\" instead of to my mother"], "\"se\" = to her (my mother); \"lo\" = it (the present)", 'Le becomes se before lo: se lo di = I gave it to her.', 'further'),
...
""",
    ...
    [
        ...
        q('sp-ex-q3', 'In the dictation section, how is "ll" usually pronounced?', ["Like the \"l\" in \"lip\"","It is silent","Like the \"y\" in \"yes\"","Like the Spanish \"j\""], "Like the \"y\" in \"yes\"", 'Most Spanish speakers pronounce ll like y.', 'intermediate'),
        q('sp-ex-q4', 'Which time marker signals the imperfect tense?', ["El año que viene…","Mañana por la mañana…","Ayer por la tarde…","Cuando era pequeño…"], "Cuando era pequeño…", 'Cuando era pequeño (when I was little) introduces what used to happen.', 'intermediate'),
        q('sp-ex-q5', 'Best translation of "Normalmente voy al instituto a pie, pero hoy he venido en autobús":', ["Normally I go to school on foot and by bus every day","I always walk to school, and today I also came by bus","I usually walk to school, but today I have come by bus","I usually go to school by bus, but today I have walked"], "I usually walk to school, but today I have come by bus", 'A pie = on foot; he venido = I have come (perfect tense).', 'higher'),
        q('sp-ex-q6', 'In a Writing task, which phrase best gives a justified opinion?', ["Me gusta la. Me gusta el. Me gusta los.","Es un deporte. Juego al fútbol. Es fútbol.","Me encanta porque me ayuda a relajarme","Sí, sí, me gusta, sí, me gusta el fútbol, sí"], "Me encanta porque me ayuda a relajarme", 'Opinion (me encanta) + reason (porque me ayuda a relajarme).', 'higher'),
        q('sp-ex-q7', 'Reading: "Mi hermano no ha ido nunca a España." Which statement is true?', ["His brother has been to Spain once","His brother has never been to Spain","His brother is going to Spain next year","His brother has lived in Spain for years"], "His brother has never been to Spain", 'No … nunca = never; ha ido = has been (perfect).', 'higher'),
        ...
        q('sp-ex-q9', 'Which is the best strategy for the photo card task?', ["Only list the objects in the photo, using as many nouns as possible","Answer in English, so that the examiner understands all of your ideas","Describe the photo, give justified opinions and use more than one tense","Say that you don't understand, so the teacher asks an easier question"], "Describe the photo, give justified opinions and use more than one tense", 'Development, justification and range are what lift the mark.', 'further'),
